...
export default function DashboardComp() {
  ...
  return (
    <div className="p-3 md:mx-auto">
      <div className="flex-wrap gap-4 flex justify-center">
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            ...
            <HiOutlineUserGroup className="bg-teal-600 text-white p-3 text-5xl rounded-full shadow-lg shadow-black" />
          </div>
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            ...
            <HiDocumentText className="bg-lime-600 text-white p-3 text-5xl rounded-full shadow-lg shadow-black" />
          </div>
          <div className="flex gap-2 text-sm">
            <span className="text-green-500 flex items-center">
              <HiArrowNarrowUp />
        ...
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            ...
            <HiAnnotation className="bg-indigo-600 text-white p-3 text-5xl rounded-full shadow-lg shadow-black" />
          </div>
          <div className="flex gap-2 text-sm">
            <span className="text-green-500 flex items-center">
              <HiArrowNarrowUp />
      ...
      <div className=" flex flex-wrap gap-4 ms-auto justify-center mt-5">
        {/* Recent Users */}
