...
export default function Projects() {
  return (
    <div className="min-h-screen max-w-2xl mx-auto flex justify-center items-center flex-col gap-6 p-3">
      ...
      <ul className="list-disc flex flex-col gap-4 text-gray-500">
        <li>
          <strong className="text-gray-700">Web Development:</strong> Build
          dynamic, responsive websites using the latest frameworks and tools.
        </li>
        <li>
          <strong className="text-gray-700">Data Science:</strong> Discover
          projects that delve into machine learning, data visualization, and
          analytics.
        </li>
        <li>
          <strong className="text-gray-700">Cloud Computing:</strong> Learn
          about scalable applications and cloud deployment strategies.
        </li>
        <li>
          <strong className="text-gray-700">AI and Machine Learning: </strong>{" "}
          Get hands-on experience with models, algorithms, and AI-driven
          applications.
        </li>
        <li>
          <strong className="text-gray-700">Mobile Development:</strong> Create
          apps for iOS and Android that enhance user experience and
          functionality.
        </li>
      </ul>
      <p>
